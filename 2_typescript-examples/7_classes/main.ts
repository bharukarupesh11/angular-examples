...
let point = new Point(1, 2); // 'point' is an object here
point.draw();


let point2 = new Point(); // Because of optional parameters in constructors we're able to create an object without passing any parameter here. 
