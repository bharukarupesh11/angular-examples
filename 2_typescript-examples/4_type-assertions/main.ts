/** 
 * Type Assertion: This is similar to the type casting in java. We specify the type of variable to help typescript
 *                 compiler know about it and then it can provide us the intellisense on it. 
 * 
 ...
 *  compiler gets little confused about the type of a variable and that time we need to specify the type 
 *  as an assertion for the compiler to sense it. 
 * 
 *  Look at the example below, 
 */
let message = 'abc'; // initialization at the time of declation 
let endWithC = message.endsWith('c'); // Note: Here, tsc compiler immediately showed us the tooltip with utility methods for the string type. 
