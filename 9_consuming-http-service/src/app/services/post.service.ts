...
export class PostService extends DataService{
  // url is a implementation detail to work with our backend
  // private url = 'https://abcdjsonplaceholder.typicode.com/posts'; // Invalid URL to simulate a unhandled exception
